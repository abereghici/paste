...
<LivePreview scope={{Box, Text, Stack, ProcessDisabledIcon, ProcessDraftIcon}} language="jsx">
  {`<Stack orientation="horizontal" spacing="space80">
      ...
      <Box display="flex">
        ...
        <Text marginLeft="spacing30">Draft</Text>
      </Box>
    </Stack>`}
</LivePreview>
...
| <ProcessInProgress /> | `ProcessInProgresslIcon` | `$color-text-icon-neutral` | Indicates that something is in progress, in review, or scheduled.                                                  |
